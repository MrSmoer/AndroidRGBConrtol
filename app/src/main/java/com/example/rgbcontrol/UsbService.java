...
public class UsbService extends Service {
    ...
    public static final String ACTION_USB_READY = "com.example.passwort.USB_READY";
    ...
    public void onCreate() {
        this.context = this;
        serialPortConnected = false;
        com.example.rgbcontrol.UsbService.SERVICE_CONNECTED = true;
        setFilter();
    ...
    public void onDestroy() {
        ...
        com.example.rgbcontrol.UsbService.SERVICE_CONNECTED = false;
    }
...
//                if (deviceVID != 0x1d6b && (devicePID != 0x0001 && devicePID != 0x0002 && devicePID != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
    ...
    public class UsbBinder extends Binder {
        public com.example.rgbcontrol.UsbService getService() {
            return com.example.rgbcontrol.UsbService.this;
        }
    }
